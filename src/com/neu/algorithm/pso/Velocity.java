...
public class Velocity {
	 ...
	 *
	 *
	 *If c = 0 then c*v gives an empty Velocity, represented by null value
	 *Else if c in (0, 1] then v is contracted to the length of floor(c*v)
	 *Else if c > 1 then c*v = v + v + ... + v + c'v, where c' in (0, 1]. v
	 *is added floor(c) times.
	 *
	 * 
	 * coeff
	 *            coefficient by which this Velocity is multiplied
	 * returns Velocity modified by multiplication
	 */
	 ...
	 * returns Velocity modified by addition
	 */
	 ...
	 * position
	 *            particle's position
	 *returns newly obtained position
	 */
